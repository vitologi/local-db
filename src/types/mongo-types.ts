...
// TODO: use https://www.npmjs.com/package/mingo and https://www.npmjs.com/package/ajv
...
export type UpdateFilter<TSchema> = {
  $currentDate?: OnlyFieldsOfType<TSchema, Date, true>;
  ...
  $bit?: OnlyFieldsOfType<TSchema, number | undefined, { and: number } | { or: number } | { xor: number }>;
} & Document;
